    ...
    async (
      ...
      switch (type) {
        ...
        case HIGHLIGHT: {
          ...
          console.log('🚀 ~ Layover ~ serializedState:', serializedState);
        ...
        case UPDATE_HIGHLIGHTS: {
          ...
          console.log('🚀 ~ Layover ~ newSerializedState:', newSerializedState);

          console.log(JSON.stringify(newSerializedState, null, 2));
    ...
    <>
      ...
      {showLayover && (
        <div id="ctrl-f-plus-extension">
          <div className="fixed left-5 top-10 z-[9999] h-0 w-0">
            <DraggableContainer>
